<x-master-layout>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image dash-icon">
                                        <svg width="52" height="45" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <ellipse cx="339.825" cy="194.5" rx="137" ry="150.5" stroke="currentColor" stroke-width="52"/>
                                            <ellipse cx="541.825" cy="572.5" rx="184" ry="184.5" stroke="currentColor" stroke-width="52"/>
                                            <path d="M539.825 480V561.5L604.5 637.5" stroke="currentColor" stroke-width="52" stroke-linecap="round"/>
                                            <path d="M298.325 508C276.992 507 227.625 498.6 200.825 473C167.325 441 116.325 463 107.325 485.5C97.6585 494.5 77.7252 522.3 75.3252 561.5V656.5C78.4919 672.5 96.4253 703.5 142.825 699.5H327.825" stroke="currentColor" stroke-width="52"/>
                                        </svg>                                        
                                    </div>
                                    <div class="mm-cart-text">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height border-radius-20">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image dash-icon">
                                        <svg width="52px" height="50px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="0.00024000000000000003" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.048"></g><g id="SVGRepo_iconCarrier"> <path d="M20 15C20.5523 15 21 14.5523 21 14C21 13.4477 20.5523 13 20 13C19.4477 13 19 13.4477 19 14C19 14.5523 19.4477 15 20 15Z" fill="currentColor"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M16.775 0.985398C18.4919 0.460783 20.2821 1.55148 20.6033 3.3178L20.9362 5.14896C22.1346 5.54225 23 6.67006 23 8V10.7639C23.6137 11.3132 24 12.1115 24 13V15C24 15.8885 23.6137 16.6868 23 17.2361V20C23 21.6569 21.6569 23 20 23H4C2.34315 23 1 21.6569 1 20V8C1 6.51309 2.08174 5.27884 3.50118 5.04128L16.775 0.985398ZM21 16C21.5523 16 22 15.5523 22 15V13C22 12.4477 21.5523 12 21 12H18C17.4477 12 17 12.4477 17 13V15C17 15.5523 17.4477 16 18 16H21ZM21 18V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V8C3 7.44772 3.44772 7 4 7H20C20.55 7 20.9962 7.44396 21 7.99303L21 10H18C16.3431 10 15 11.3431 15 13V15C15 16.6569 16.3431 18 18 18H21ZM18.6954 3.60705L18.9412 5H10L17.4232 2.82301C17.9965 2.65104 18.5914 3.01769 18.6954 3.60705Z" fill="currentColor"></path> </g></svg>
                                    </div>
                                    <div class="mm-cart-text">
    ...
    <style>
        /* Dashboard icon color: adapts to dark/light mode */
        .dash-icon { color: #374151; }
        body.dark .dash-icon { color: #e5e7eb; }
    </style>
    <script>
        // ─── Dark/Light mode helper ───────────────────────────────────────────
        function getChartTextColor() {
            return document.body.classList.contains('dark') ? '#e5e7eb' : '#374151';
        }
        function getGridColor() {
            return document.body.classList.contains('dark') ? '#374151' : '#e5e7eb';
        }
        ...
        // Original Income Chart
        var options = {
            series: [{
                name: "{{ __('message.cash') }}",
                data: [ <?= implode ( ',' , $data['cash_yearly'] ) ?> ]
            }, {
                name: "{{ __('message.card') }}",
                data:[ <?= implode ( ',' , $data['card_yearly'] ) ?> ]
            }, {
        ...
        document.addEventListener('ChangeColorMode', function(e) {
            var tc  = getChartTextColor();
            var gc  = getGridColor();
            var opts = {
                legend:      { labels: { colors: tc } },
                dataLabels:  { style:  { colors: [tc] } },
                xaxis:       { labels: { style: { colors: tc } } },
                yaxis:       { labels: { style: { colors: tc } } },
                grid:        { borderColor: gc }
            };
            // Donut total-label colour
            chartSchedule.updateOptions(Object.assign({}, opts, {
                plotOptions: { pie: { donut: { labels: { total: { color: tc } } } } }
            }));
            chartSubscriptionEarning.updateOptions(opts);
