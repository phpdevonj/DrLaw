                        ...
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::text('title', old('title'),[ 'placeholder' => __('message.title'),'class' =>'form-control','required', 'disabled']) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('coupon_type',__('message.coupon_type').' <span class="text-danger">*</span>',[ 'class' => 'form-control-label'],false) }}
                                    {{ Form::select('coupon_type', [ 'all' => __('message.all'), 'first_ride' => __('message.first_ride'), 'region_wise' => __('message.region_wise'), 'service_wise' => __('message.service_wise'), 'new_user' => __('message.new_user') ],  old('coupon_type'),[
                                        'class' =>'form-control select2js', 'required', 'disabled']) 
                                    }}
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::number('usage_limit_per_rider', old('usage_limit_per_rider'), [ 'class' => 'form-control', 'min' => 0, 'placeholder' => __('message.usage_limit_per_rider'), 'disabled' ]) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('start_date', __('message.start_date'), [ 'class' => 'form-control-label']) }}
                                    {{ Form::text('start_date', old('start_date'),[ 'placeholder' => __('message.start_date'),'class' => 'form-control', 'disabled']) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('end_date', __('message.end_date'), [ 'class' => 'form-control-label']) }}
                                    {{ Form::text('end_date', old('end_date'),[ 'placeholder' => __('message.end_date'),'class' => 'form-control', 'disabled']) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('discount_type',__('message.discount_type'), ['class' => 'form-control-label']) }}
                                    {{ Form::select('discount_type',[ 'fixed' => __('message.fixed') ,'percentage' => __('message.percentage') ], old('discount_type') ,[ 'class' =>'form-control select2js','required', 'disabled']) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('discount', __('message.discount').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::number('discount', old('discount'), ['class' => 'form-control', 'min' => 0, 'step' => 'any', 'required', 'placeholder' => __('message.discount'), 'disabled' ]) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('minimum_amount', __('message.minimum_amount').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::number('minimum_amount', old('minimum_amount'), ['class' => 'form-control', 'min' => 0, 'step' => 'any', 'required', 'placeholder' => __('message.minimum_amount'), 'disabled' ]) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('maximum_discount', __('message.maximum_discount').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::number('maximum_discount', old('maximum_discount'), ['class' => 'form-control', 'min' => 0, 'step' => 'any', 'required', 'placeholder' => __('message.maximum_discount'), 'disabled' ]) }}
                                </div>
                                
                                <div class="form-group col-md-4">
                                    {{ Form::label('status',__('message.status').' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                                    {{ Form::select('status',[ '1' => __('message.active'), '0' => __('message.inactive') ], old('status'), [ 'class' =>'form-control select2js','required', 'disabled']) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('description', __('message.description'), ['class'=>'form-control-label'] ) }}
                                    {{ Form::textarea('description', null, ['class' => 'form-control textarea', 'rows' => 3, 'placeholder'=> __('message.description'), 'disabled' ]) }}
                                </div>
                            </div>
                            <!-- <hr>
