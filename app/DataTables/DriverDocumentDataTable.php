            ...
            ->editColumn('is_verified', function($query) {
                ...
                switch ($query->is_verified) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        $is_verified = 'secondary';
                        $is_verified_label = __('message.expired');
                        break;
                    default:
        ...
        return [
            Column::make('DT_RowIndex')
               ...
               ->title('#')
                ->orderable(false)
                ->width(60),
            Column::make('driver_id')->title( __('message.driver_name') ),
            Column::make('document_id')->title(__('message.document_type')),
            Column::make('expire_date')->title( __('message.expiry_date') ),
