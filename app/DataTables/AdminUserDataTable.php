...
class AdminUserDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\AdminUserDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AdminUserDataTable $model)
    {
        $model = User::whereNotIn('user_type',['rider','driver','admin']);
        if (request()->rider_id) {
    ...
    // {
    //     return $this->builder()
    //                 ->setTableId('adminuserdatatable-table')
